...
Based on ![lucid](https://github.com/tensorflow/lucid). TODO: This isn't currently public, but we should figure out the legalities.
"""
...
from devinterp.viz.objectives_utils import (_dot_cossim, _extract_act_pos,
                                            _make_arg_str, _T_force_NHWC,
                                            _T_handle_batch)
...
def wrap_objective(require_format=None, handle_batch=False):
  ...
  Changes f from the closure: (args) => () => Torch tensor
