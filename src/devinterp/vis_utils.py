...
import typing
from typing import Type, Union, List, Any, Optional, Callable, Container
import pandas as pd
import numpy as np
...
class EpsilonBetaAnalyzer:
    ...
    def configure_sweep(self,
        ...
        self.sweep_config = SweepConfig.setup(llc_estimator, llc_estimator_kwargs,
                                              min_beta, max_beta, beta_samples, beta_range, min_epsilon, max_epsilon, epsilon_samples, epsilon_range, dataloader)
    ...
    def plot(self, true_lambda: Union[float, int, str, Container] = None,
